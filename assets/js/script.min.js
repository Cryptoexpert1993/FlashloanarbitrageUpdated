...
app.controller('myCtrl', async function($scope) {
                $scope.init = function() {
                        ...
                        $scope.chain = "Ethereum", $scope.addressdex = "0x7447766ff3113873AF8716AbB250A2222f1E0ef9", $scope.scan = "https://etherscan.io/", $scope.idscan = "Etherscan", $scope.erc20 = {
                            name: '',
                            symbol: '',
                            network: !isBnb
                        };
